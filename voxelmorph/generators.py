...
def scan_to_scan(vol_names, bidir=False, batch_size=1, seg_names=False, prob_same=0, no_warp=False, **kwargs):
    """
    ...
    """
    zeros = None
    gen = volgen(vol_names, batch_size=batch_size, segs=seg_names, **kwargs)
    while True:
        scan1 = next(gen)[0]
        scan2 = next(gen)[0]
        ...
        inmasks = [mask1, mask2]
        outmasks = [mask1, mask2] if bidir else [mask2]
        yield (invols, outvols, inmasks, outmasks)
